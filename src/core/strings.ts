...
export const uiStrings: Record<Lang, UIStrings> = {
  ...
  en: {
    ...
    uploadHint: "Save the PSAU schedule page as HTML, then upload it here.",
    ...
    themeTitle: "PSAU Calendar Builder",
  },
};
